...
async def main():
    ...
    put_markdown("## Добро пожаловать!\nПожалуйста, скиньте исходный код вашего сайта, и мы туда добавим функцию!")
    ...
    msg_box.append(put_markdown(f'📢 Клиент `{nickname}` покинул чат!'))
    chat_msgs.append(('📢', f'Клиент `{nickname}` покинул чат!'))
